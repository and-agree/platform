Feature:
    ...
    Scenario: Sending of emails when a decision is created
        ...
        When there is a decision created using:
            ...
            | general  | { "title": "Title", "goal": "Goal", "background": "Background", "instructions": "Instructions", "deadline": "2021-06-06T12:30:00Z" } |
            | deciders | [{ "email": "example@test.andagree.com", "pending": true, "response": "UNKNOWN" }]                                                   |
